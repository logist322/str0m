...
mod test {
    ...
    fn check_reorder_rtp() {
        ...
        let mut buffer = DepacketizingBuffer::new(
            CodecDepacketizer::Vp9(Vp9Depacketizer::default()).into(),
            30,
        );
        ...
        assert_eq!(res1before.data, res1after.data); // Must be equal too!
    }
}
